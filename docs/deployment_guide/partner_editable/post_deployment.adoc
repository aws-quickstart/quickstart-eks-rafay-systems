...
2.	In the Rafay console, select *Infrastructure, Clusters* to access details about the newly imported cluster. Refer to <<testing1>> for an example of imported cluster information in the Rafay console.

[#testing1]
.Imported cluster information in the Rafay console
image::../docs/deployment_guide/images/testing-deployment.png[width=100%,height=100%]
