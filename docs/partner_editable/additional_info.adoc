...
* Two types of credentials are supported: IAM role and IAM user. For more information about how to create and configure KMC credentials, see the https://docs.rafay.co/clusters/provision/eks/credentials/[KMC documentation^].
...
* https://docs.rafay.co/[Rafay KMC documentation^]
