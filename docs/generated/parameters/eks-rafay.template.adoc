...
(`QSS3KeyPrefix`)|`quickstart-amazon-eks/submodules/quickstart-eks-rafay/`|S3 key prefix for the Quick Start assets. This string can include numbers, lowercase letters, uppercase letters, hyphens (-), periods (.), and forward slashes (/).
|===